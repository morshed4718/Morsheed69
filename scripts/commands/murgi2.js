...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি  ইমরান তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi ইমরান এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi ইমরান এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a({body: "চুদে যাবো তরে ভুদার মধ্যে হারপিক ভরে 😹💦  ✋" + " " + name, mentions: arraytag})},39000);
setTimeout(() => {a({body: "এই খানকি মাগী\nবেশ্যার মাগীর ঘরের\n\n ৩ কুত্তার চোদার জন্ম হওয়া হিজরা\n\n\nচোদন চোদন কার বাড়ি তোর মাকে চুদে পঠাবো তোর নানার বাডি💀\nআমার ইঞ্জিন হচ্ছে ৭ইঞ্চি তোর মায়ের হেডার পুটো হচ্ছে ১৪ ইঞ্চি \nএই কনডম পুটোয় জন্ম হওয়া মাগীর পোলা,\n তোর মারে চুদি করবো জালাপালা\nআমি ১০ রকেটের গতিতে চুদে জন্ম দিলাম তাই তোর জন্ম হলো\n\n\nতোর কালকেই তোর মায়েদ একটা জারজ সন্তান হবে খবর নিয়ে দেখ\nতোর মায়ের সাথে এক বিচানায় শুয়ে আছি গিয়ে দেখে আয়" + " " + name, mentions: arraytag})},3000);
setTimeout(() => {a({body:"তোর মায়ের হেডার দৈঘ্য প্রস্থা যোগ করে ফিতা কৌশের সূত্র প্রয়োগ করে তোর মায়ের হেডার পুটোর ক্ষেএফল নির্ণয় করবোতোর মায়ের হেডার দৈঘ্য প্রস্থা যোগ করে ফিতা কৌশের সূত্র প্রয়োগ করে তোর মায়ের হেডার পুটোর ক্ষেএফল নির্ণয় করবোতোর মায়ের হেডার দৈঘ্য প্রস্থা যোগ করে ফিতা কৌশের সূত্র প্রয়োগ করে তোর মায়ের হেডার পুটোর ক্ষেএফল নির্ণয় করবো" + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body:"তোর মাকে ৬ জনের ধোন দিয়ে চুদব,,,ওর মায়ের দুইহাতে ২ টা ধোন,,গুদে একটা আর পুটকিতে একটা আর মুখে একটা আর দুধের মাঝখানে একটা😛😛😛😛😛😛😛"+ " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body:"তোর মা কে আলোর গতিতে চুদিিি"+ " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a("~ আমার জারজ পুত। জা ভাগ🤖")} , 12000);
